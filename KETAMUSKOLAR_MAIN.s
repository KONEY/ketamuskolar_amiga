...
Demo:	;MOVE.W	#16,MED_START_POS		; skip to pos# after first block
...
__BLIT_GLITCH_TILE:
	...
	BEQ.S	.waitData			
	.dataOk:
	CMP.L	#_MED_MODULE-bpl,A3		; LAST WORD OF DATA?
	BLS.S	.notEnd
	MOVE.L	GLITCHRESET,A3		; RELOAD
	.notEnd:
...
__BLK_PLASMA:
	...
	MOVE.L	#GRADIENTPLANENEG+bpl/2,A3
...
TEXTINDEX:	DC.W 0
FRAMESINDEX:	DC.W 4
GLITCHGOOD:	DC.L MED_MODULE+h*bpl*6
GLITCHRESET:	DC.L MED_MODULE+h*bpl*4+h*bpl/2
