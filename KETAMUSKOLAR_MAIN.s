...
Demo:	MOVE.W	#10,MED_START_POS		; skip to pos# after first block
	...
	MOVE.L	#BG_DITHER,SCROLL_SRC	; FILLS A PLANE
	MOVE.L	#GRADIENTPLANENEG,SCROLL_DEST	; FILLS A PLANE
	MOVEQ	#0,D3			; CONTROLS NEGATIVE
	BSR.W	__GRADIENT_PLANE		; WITH DITHERING
...
MainLoop:
	...
	;move.l	a2,a1
	;MOVE.L	#PLANE3,A2
	;MOVE.L	#PLANE3_BUF,A3
	;EXG	A2,A3
	;MOVEM.L	A3,#PLANE3
	;MOVEM.L	A2,#PLANE3_BUF
	;MOVE.L	A3,A0
...
__WIPE_PLANE_UNUSED:			; a1=screen destination address to clear
	LEA	$910(A1),A1		; OPT of ADD.L #h/4*bpl,A1
	;LEA	EMPTY_PLANE,A2
	BSR	WaitBlitter
...
__STROBE_COLOR:
	...
	BRA.S	.evenFrame
	.oddFrame:
	MOVE.L	#(GREEN_REG<<16)|CYAN_VAL,COPPER\.Palette+$14	; SUPER OPT SYNTAX | 28 CYCLES
	.evenFrame:
	; ## STROBE COLOR ##
	RTS
...
__SCROLL_X_PROGR_SPLIT:
	...
	MOVE.W	#bpl*X_SPLIT_SLICE-1,D6	; OPTIMIZE
	MOVE.W	#bpl*X_SPLIT_SLICE,D7	; OPTIMIZE
...
__BLK_DIAG_FLUID1:
	...
	MOVE.L	#PLANE0,SCROLL_SRC
	MOVE.L	#PLANE0,SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	MOVE.L	#PLANE1,SCROLL_SRC
	MOVE.L	#PLANE1,SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	...
	MOVE.L	#PLANE0+bpl*h/2-(bpl/2),SCROLL_SRC
	MOVE.L	#PLANE0+bpl*h/2-(bpl/2),SCROLL_DEST
	;ADD.L	#bpl*h/2-(bpl/2),SCROLL_SRC
	;ADD.L	#bpl*h/2-(bpl/2),SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4

	MOVE.L	#PLANE1+bpl*h/2-(bpl/2),SCROLL_SRC
	MOVE.L	#PLANE1+bpl*h/2-(bpl/2),SCROLL_DEST
	;ADD.L	#bpl*h/2-(bpl/2),SCROLL_SRC
	;ADD.L	#bpl*h/2-(bpl/2),SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	...
	MOVE.L	#PLANE0+bpl/2,SCROLL_SRC
	MOVE.L	#PLANE0+bpl/2,SCROLL_DEST
	;ADD.L	#bpl/2,SCROLL_SRC
	;ADD.L	#bpl/2,SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	MOVE.L	#PLANE1+bpl/2,SCROLL_SRC
	MOVE.L	#PLANE1+bpl/2,SCROLL_DEST
	;ADD.L	#bpl/2,SCROLL_SRC
	;ADD.L	#bpl/2,SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	...
	MOVE.L	#PLANE0+bpl*(h/2),SCROLL_SRC
	MOVE.L	#PLANE0+bpl*(h/2),SCROLL_DEST
	;ADD.L	#bpl*(h/2),SCROLL_SRC
	;ADD.L	#bpl*(h/2),SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	MOVE.L	#PLANE1+bpl*(h/2),SCROLL_SRC
	MOVE.L	#PLANE1+bpl*(h/2),SCROLL_DEST
	;ADD.L	#bpl*(h/2),SCROLL_SRC
	;ADD.L	#bpl*(h/2),SCROLL_DEST
	BSR.W	__SCROLL_X_Y_1_4
	.evenFrame:
...
__BLK_SHUFFLE:
	...
	MOVE.L	#PLANE0+bpl*(h+32)/2,SCROLL_SRC
	MOVE.L	#PLANE0+bpl*(h+32)/2,SCROLL_DEST
	...
	MOVE.L	#PLANE1+bpl*(h+32)/2,SCROLL_SRC
	MOVE.L	#PLANE1+bpl*(h+32)/2,SCROLL_DEST
	...
	MOVE.L	#PLANE0+bpl*(h+32)/2-(bpl/2),SCROLL_SRC
	MOVE.L	#PLANE0+bpl*(h+32)/2-(bpl/2),SCROLL_DEST
	...
	MOVE.L	#PLANE1+bpl*(h+32)/2-(bpl/2),SCROLL_SRC
	MOVE.L	#PLANE1+bpl*(h+32)/2-(bpl/2),SCROLL_DEST
	;ADD.L	#bpl*(h+32)/2-(bpl/2),SCROLL_SRC
	;ADD.L	#bpl*(h+32)/2-(bpl/2),SCROLL_DEST
	MOVE.B	#-1,Y_1_4_DIR
	BSR.W	__SCROLL_Y_1_4
...
__BLK_SCREEN2:
	...
	;BSR.W	__X_SHIFT_LFO
	MOVE.L	#PLANE1+bpl*(h-2)-2,SCROLL_DEST
	;SUB.L	#2,SCROLL_DEST
	BSR.W	__BLIT_GLITCH_BAND
...
__BLK_GRADIENT_MIX:
	...
	MOVE.L	#GRADIENTPLANE,SCROLL_SRC
	MOVE.L	#PLANE0,SCROLL_DEST
	...
	MOVE.L	#GRADIENTPLANENEG,SCROLL_SRC
	MOVE.L	#PLANE1,SCROLL_DEST
...
__BLK_NEW_VECT:
	...
	MOVE.W	AUDIOCHLEV_1,D0
	LSR.W	#2,D0
	MOVE.W	D0,BLIT_A_MOD
	MOVE.W	AUDIOCHLEV_2,D0
	LSR.W	#2,D0
	MOVE.W	D0,BLIT_D_MOD

	MOVE.B	#$0,Y_LFO_INVERT_DIR
	MOVE.B	#$0,Y_SHIFT_LFO_MIN
	MOVE.B	#$8,Y_SHIFT_LFO_MAX
	BSR.W	__Y_SHIFT_LFO
	MOVE.W	Y_FULL_SHIFT,Y_HALF_SHIFT	; VSHIFT
	...
	.evenFrame:
	MOVE.L	#PLANE3,A1		; SCROLL_DEST
	MOVE.L	A1,SCROLL_DEST
	BSR.W	__WIPE_PLANE
...
__BLK_VECTOR_SPREAD:
	...
	;######## BLOCK SHUFFLE ##########
	;MOVE.W	#$F5AF,BLIT_PATT
	;MOVE.L	#PLANE0,SCROLL_DEST
	;TST.W	MED_STEPSEQ_POS
	;BEQ.S	.skip3
	;MOVE.W	BLIT_PATSHIFT,D0
	;ROR.W	#2,D0
	;MOVE.W	D0,BLIT_PATSHIFT
	;MOVE.W	D0,BLIT_PATT
	;.skip3:
	...
	;## VERTICAL GLITCH ###########
	MOVE.L	#PLANE0+bpl/2-2,SCROLL_DEST
...
__BLK_DISPERSE:
	...
	ADD.L	D1,GLITCHGOOD
	MOVE.L	#PLANE0+bpl*(h-16+6),SCROLL_DEST
...
__BLK_MULTI:
	...
	BNE.S	.noChangeDir
	MOVE.B	MED_TRK_3_NOTE,D1
	CMP.B	#$03,D1			; $03 $01 $0F $16 $10 $13
	BEQ.S	.okChangeDir
	CMP.B	#$13,D1			; $03 $01 $0F $16 $10 $13
	BNE.S	.noChangeDir
	.okChangeDir:
	MOVE.W	V_DIR,D5
	NEG.W	D5
	MOVE.W	D5,V_DIR
	.noChangeDir:
	;MOVE.W	MED_BLOCK_LINE,D1		; UHM...
	;CMP.W	#$1,D1
	;BNE.S	.noChangePtr
	;ADDI.L	#4,VECT_PTR		; MESSES COORDZ
	;.noChangePtr:
...
__BLK_0_VECT:
	...
	;MOVE.L	#PLANE0,A1		; SCROLL_DEST
	;MOVE.L	A1,SCROLL_DEST
	;;BSR.W	__WIPE_PLANE
	;MOVE.W	#$AAAA,BLIT_PATT
	...
	;MOVE.L	#PLANE1,A1		; SCROLL_DEST
	;MOVE.L	A1,SCROLL_DEST
	;;BSR.W	__WIPE_PLANE
	;MOVE.W	#$5555,BLIT_PATT
	;MOVE.W	#$1,V_MAX_VECTORS
	;BSR.W	__BLIT_VECTORS
	.evenFrame:
...
TIMELINE:		DC.L __BLK_BEGIN,__BLK_BEGIN_MID,__BLK_BEGIN_PRE,__BLK_BEGIN		;1
		...
		;DC.L __BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD
		DC.L __BLK_0_VECT,__BLK_0_VECT,__BLK_0_VECT,__BLK_0_VECT				;34 25: DE-LI-RI-O!
		DC.L __BLK_0_VECT,__BLK_0_VECT,__BLK_0_VECT,__BLK_PLASMA_VECT			;38 25: DE-LI-RI-O!
		DC.L __BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD_PRE	;34 25: DE-LI-RI-O!
		DC.L __BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD,__BLK_VECTOR_SPREAD	;42 25: DE-LI-RI-O!

		DC.L __BLK_GRADIENT_MIX,__BLK_GRADIENT_MIX,__BLK_GRADIENT_MIX,__BLK_GRADIENT_MIX	;4 25: DE-LI-RI-O!
		;DC.L __BLK_NEW_VECT,__BLK_NEW_VECT,__BLK_NEW_VECT,__BLK_NEW_VECT		;34 25: DE-LI-RI-O!
		; #### ;
		DC.L __BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT	;34 25: DE-LI-RI-O!
		DC.L __BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_PLASMA_VECT	;38 25: DE-LI-RI-O!
		DC.L __BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT	;34 25: DE-LI-RI-O!
		DC.L __BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT,__BLK_MULTI_VECT	;34 25: DE-LI-RI-O!
		; # TIMELINE OK SO FAR #
		...
		DC.L __BLK_RESET,__BLK_SHUFFLE,__BLK_RESET,__BLK_SHUFFLE
		DC.L __BLK_DIAG_FLUID1,__BLK_DIAG_FLUID1,__BLK_DIAG_FLUID1,__BLK_DIAG_FLUID1
		DC.L __BLK_0,__BLK_BLEND,__BLK_0,__BLK_BLEND
		DC.L __BLK_RESET,__BLK_PLASMA,__BLK_RESET,__BLK_PLASMA
		DC.L __BLK_SCREEN2,__BLK_SHUFFLE,__BLK_SCREEN2,__BLK_SHUFFLE
		DC.L __BLK_TEST_Y,__BLK_PLASMA,__BLK_TEST_Y,__BLK_PLASMA
		DC.L __BLK_SHUFFLE,__BLK_SHUFFLE,__BLK_SHUFFLE,__BLK_SHUFFLE
		DC.L __BLK_SCREEN,__BLK_PLASMA,__BLK_SCREEN,__BLK_PLASMA
		DC.L __BLK_SCREEN3,__BLK_PLASMA,__BLK_SCREEN3,__BLK_PLASMA
		DC.L __BLK_END

TIMELINE_INNER:	DC.L __BLK_ROUND,__BLK_ROUND,__BLK_ROUND,__BLK_ROUND
		DC.L __BLK_ROUND,__BLK_ROUND,__BLK_KICK,__BLK_ROUND
		DC.L __BLK_ROUND,__BLK_ROUND,__BLK_ROUND,__BLK_ROUND
		DC.L __BLK_ROUND,__BLK_ROUND,__BLK_ROUND,__BLK_KICK
		;DC.L __BLK_BLEND,__BLK_BLEND,__BLK_BLEND,__BLK_BLEND
		DC.L __BLK_DIAG_FLUID2,__BLK_DIAG_FLUID2,__BLK_DIAG_FLUID1,__BLK_BLEND
		;DC.L __BLK_VECTOR,__BLK_PLASMA,__BLK_SHUFFLE,__BLK_PLASMA
...
COLORSEQ4:	DC.W $0188,$0554,$018A,$01A2,$018C,$0556,$018E,$0444
		DC.W $0188,$0445,$018A,$0293,$018C,$0555,$018E,$0333
		DC.W $0188,$0444,$018A,$0383,$018C,$0444,$018E,$0222
		DC.W $0188,$0344,$018A,$0374,$018C,$0344,$018E,$0111
		DC.W $0188,$0334,$018A,$0464,$018C,$0334,$018E,$0011
		DC.W $0188,$0334,$018A,$0454,$018C,$0333,$018E,$0111
		DC.W $0188,$0334,$018A,$0455,$018C,$0333,$018E,$0222
		DC.W $0188,$0334,$018A,$0445,$018C,$0333,$018E,$0333
		DC.W $0188,$0334,$018A,$0445,$018C,$0333,$018E,$0333

		DC.W $0180,$0001,$0182,$0222,$0184,$0333,$0186,$0444
		DC.W $0180,$0001,$0182,$0232,$0184,$0323,$0186,$0344
		DC.W $0180,$0111,$0182,$0233,$0184,$0323,$0186,$0344
		DC.W $0180,$0212,$0182,$0333,$0184,$0323,$0186,$0345
		DC.W $0180,$0121,$0182,$0344,$0184,$0233,$0186,$0345
		DC.W $0180,$0221,$0182,$0444,$0184,$0233,$0186,$0345
		DC.W $0180,$0222,$0182,$0445,$0184,$0223,$0186,$0345
...
COPPER:
	...
	;DC.W $0190,$0888,$0192,$0888,$0194,$0999,$0196,$0BBB
	DC.W $0190,$0CCC,$0192,$0DDD,$0194,$0EEE,$0196,$00EE
	DC.W $0198,$00FF,$019A,$0F00,$019C,$0DDD,$019E,$0FFF
