...
__BLK_DIAG_FLUID1:
	...
	;ADD.L	#bpl*h/2-(bpl/2),A3
	;ADD.L	#bpl*h/2-(bpl/2),A4
	BSR.W	__SCROLL_X_Y_1_4
...
__BLK_SHUFFLE:
	...
	;ADD.L	#bpl*(h+32)/2-(bpl/2),A3
	;ADD.L	#bpl*(h+32)/2-(bpl/2),A4
	MOVE.B	#-1,Y_1_4_DIR
	BSR.W	__SCROLL_Y_1_4
...
__BLK_TEST_Y:
	...
	ADD.L	#bpl*(h+32)/2-(bpl/2)-bpl,A3
	ADD.L	#bpl*(h+32)/2-(bpl/2)-bpl,A4
