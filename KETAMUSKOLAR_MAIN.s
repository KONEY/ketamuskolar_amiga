...
__SCROLL_Y_FULL:
	...
	bsr	WaitBlitter
	MOVE.L	#$FFFFFFFF,BLTAFWM		; THEY'LL NEVER
	MOVE.W	#bypl*he-wblit-1,D6		; OPTMZ
	...
	;MOVE.W	#he*64+wblit/2,BLTSIZE	; BLTSIZE
	MOVE.W	D4,BLTSIZE		; BLTSIZE
...
__SCROLL_X_PROGR:
	...
	bsr	WaitBlitter
	MOVE.L	#$FFFFFFFF,BLTAFWM		; THEY'LL NEVER
	MOVE.W	#bypl*32-1,D6		; OPTIMIZE
	MOVE.W	#bypl*32,D7		; OPTIMIZE
...
__SCROLL_Y_PROGR:
	...
	;MULU.W	#64,D4
	LSL.W	#6,D4			; X64 OPTIMIZED
	ADD.W	#vbarwbpl,D4		; #he*64+vbarwbpl,BLTSIZE	; BLTSIZE
	...
	MOVE.W	#bypl-vbarwbpl*2,BLTAMOD	; BLTAMOD
	MOVE.W	#bypl-vbarwbpl*2,BLTDMOD	; BLTDMOD
	MOVE.L	A3,BLTAPTH		; BLTAPT SRC
	MOVE.L	A4,BLTDPTH		; DESC
...
__SCROLL_X_PROGR_SPLITX2:
	...
	MOVE.W	#bypl*X_SPLIT2X_SLICE-1,D0	; OPTIMIZE
	MOVE.W	#bypl*X_SPLIT2X_SLICE,A6	; OPTIMIZE
	...
	MOVE.L	A3,BLTAPTH		; BLTAPT
	MOVE.L	A4,BLTDPTH
	MOVE.W	#X_SPLIT2X_SLICE*64+wi/16,BLTSIZE
...
__SCROLL_Y_1_4:
	...
	MOVE.W	#bypl*(he-32)/2-(bypl/2)-1,D6	; OPTIMIZE
	MOVE.L	#((bypl/2)<<16)+bypl/2,D7
	...
	MOVE.L	A3,BLTAPTH		; BLTAPT SRC
	MOVE.L	A4,BLTDPTH		; DESC
	MOVE.W	#(he+32)/2*64+wi/2/16,BLTSIZE	; BLTSIZE
	; ## MAIN BLIT ####
	RTS
...
__SCROLL_X_Y_1_4:
	...
	MOVE.W	#bypl*he/2-(bypl/2)-1,D7	; OPTIMIZE
...
__BLK_DIAG_FLUID1:
	...
	MOVE.L	#PLANE1+bypl*he/2-(bypl/2),A3
	MOVE.L	A3,A4
	BSR.W	__SCROLL_X_Y_1_4
...
__BLK_PLASMA:
	...
	MOVE.W	MED_BLOCK_LINE,D3		; FLICKER
	CMP.W	#60,D3
	BEQ.S	.doDither
	MOVE.L	#PLANE0,A3
	MOVE.L	A3,A4
	...
	MOVE.L	#GRADIENTPLANENEG+bypl/2,A3
	MOVE.L	#PLANE0+bypl/2,A4
	BSR.W	__SCROLL_X_PLASMA
	MOVE.L	GLITCHGOOD,A3
	MOVE.L	#PLANE1+bypl/2,A4
	BSR.W	__SCROLL_X_PLASMA
	.doneDither:
...
__BLK_SHUFFLE:
	...
	MOVE.B	#1,X_1_4_DIR
	BSR.W	__SCROLL_X_1_4
	MOVE.L	#PLANE0+bypl*(he+32)/2-(bypl/2),A3
	MOVE.L	A3,A4
	MOVE.B	#-1,Y_1_4_DIR
	BSR.W	__SCROLL_Y_1_4
	...
	MOVE.B	#1,X_1_4_DIR
	BSR.W	__SCROLL_X_1_4
	MOVE.L	#PLANE1+bypl*(he+32)/2-(bypl/2),A3
	MOVE.L	A3,A4
	MOVE.B	#-1,Y_1_4_DIR
	BSR.W	__SCROLL_Y_1_4
	.evenFrame:
...
__BLK_BEGIN:
	...
	;## GLITCH ####################
	MOVE.W	#2*64+wi/16,BLIT_SIZE
	MOVE.W	#-1,BLIT_A_MOD
	MOVE.W	#0,BLIT_D_MOD

	MOVE.L	#PLANE0+bypl*(he-2),A4
	BSR.W	__BLIT_GLITCH_BAND
	MOVE.L	#PLANE1+bypl*(he-2),A4
	BSR.W	__BLIT_GLITCH_BAND
	MOVE.W	#0,BLIT_A_MOD
	;## GLITCH ####################
...
__BLK_DISPERSE:
	...
	ADD.L	D2,GLITCHGOOD
	MOVE.L	#PLANE0+bypl*(he-16+6),A4
	BSR.W	__BLIT_GLITCH_BAND
	MOVE.L	#PLANE1+bypl*(he-16+6),A4
	BSR.W	__BLIT_GLITCH_BAND
	;## DRAW GLITCH ##
...
__BLK_VECT_ALT_0_EXPL:
	...
	MOVE.B	#1,Y_FULL_DIR
	MOVE.W	#$6000|(.runOnce-(__BLK_VECT_ALT_0_EXPL+2)),__BLK_VECT_ALT_0_EXPL	; mock a BRA.S
	.runOnce:			; BEWARE THE SMC !!
	MOVE.W	MED_BLOCK_LINE,D0
	CMP.W	#32,D0
	BLO.S	__BLK_0_VECT
...
__BLK_0_VECT:
	BRA.S	.skipNormally
	.chgDir:
	MOVE.W	AUDIOCHLEV_1,AUDIOCHLEV_0	; TRICK TO FAKE DIR CHANGE :)
	.skipNormally:
	...
	MOVE.B	X_PROGR_DIR,D5		; FIX FOR DIRECTIONS BUG
	TST.W	MED_STEPSEQ_POS
	BNE.S	.noChangeDir
	MOVE.W	AUDIOCHLEV_0,D1
	CMP.W	#$C,D1
	...
	MOVE.B	D5,X_PROGR_DIR
	.noChangeDir:
	MOVE.B	D5,Y_FULL_DIR		; FIX FOR DIRECTIONS BUG
...
__BLK_END:
	...
	BSR.W	PokePtrs
	;### NEW BPL POINTERS ####
	MOVE.W	#$6000|(.runOnce-(__BLK_END+2)),__BLK_END	; mock a BRA.S
	.runOnce:			; BEWARE THE SMC !!
	LEA	PLANE3,A1
	MOVE.L	A1,A4
	BSR.W	__WIPE_PLANE
...
TIMELINE:	
	...
	DC.L __BLK_0_VECT,__BLK_0_VECT,__BLK_VECT_ALT_0_EXPL,__BLK_PLASMA_VECT\.runOnce				;38 25: DE-LI-RI-O!
	...
	DC.L __BLK_VECTOR_SPREAD_PRE\.noSpread,__BLK_VECTSPRD_KICK,__BLK_0_VECT\.chgDir,__BLK_0_VECT\.chgDir
	DC.L __BLK_0_VECT\.chgDir,__BLK_VECT_ALT_0_EXPL,__BLK_VECT_ALT_0_EXPL,__BLK_VECT_ALT_0_EXPL
...
PLASMA_DIR:	DC.B -1
FRAME_STROBE:	DC.B 0
PLN3_IS_WIPED:	DC.B 0,0

TEXTINDEX:	DC.W 0
FRAMESINDEX:	DC.W 4
GLITCHGOOD:	DC.L MED_MODULE+he*bypl*6
GLITCHRESET:	DC.L MED_MODULE+he*bypl*4+he*bypl/2
...
COLSEQ_RESET:	DC.W $0180,$0222,$0182,$0333,$0184,$0433,$0186,$0444
		...
		DC.W $01A0,$0CCC,$01A2,$0BBB,$01A4,$0EEE,$01A6,$0BBB
		DC.W $01A8,$0EEE,$01AA,$0FFF,$01AC,$0CCC,$01AE,$0FFF

		DC.W $01B0,$0BBB,$01B2,$0223,$01B4,$0121,$01B6,$0122
		DC.W $01B8,$0332,$01BA,$0BBB,$01BC,$0DDD,$01BE,$0FFF
...
MED_MODULE:	INCBIN "med/KETAMUSkOLAR_2020FIX7.med"
_chipzero:	DC.L 0
_MED_MODULE:
...
PLANE1:		DS.B he*bypl
BLEED2:		DS.B 64*bypl
PLANE3:		DS.B he*bypl	; FOR 3D
BLEED3:		DS.B 64*bypl
GRADIENTPLANE:	DS.B he*bypl	; for CRT fx
GRADIENTPLANENEG:	DS.B he*bypl	; for CRT fx
DITHERPLANE:	DS.B he*bypl	; 1 plane
HEADER:		DS.B 12*bypl
FOOTER:		DS.B 11*bypl*2	; HI-RES
FOOTER_END:	DS.B 0		; ??
END
