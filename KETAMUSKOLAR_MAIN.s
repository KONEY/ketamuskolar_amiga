...
Demo:	MOVE.W	#33,MED_START_POS		; skip to pos# after first block
...
__BLK_DIAG_FLUID1_PRE:
	...
	BSR.W	PokePtrs
	;### NEW BPL POINTERS ####
	MOVE.W	#$6000|(.runOnce-(__BLK_DIAG_FLUID1_PRE+2)),__BLK_DIAG_FLUID1_PRE	; mock a BRA.S
...
__BLK_NEW_VECT:
	...
	;BSR.W	PokePtrs
	;;### NEW BPL POINTERS ####
	;MOVE.B	#-1,Y_HALF_DIR	; HACK ;)
	;MOVE.W	#$6000|(.runOnce-(__BLK_NEW_VECT+2)),__BLK_NEW_VECT	; mock a BRA.S
	;.runOnce:			; BEWARE THE SMC !!

	;TST.B	$DFF005		; CHECK LONG FRAME
...
__BLK_DISPERSE:
	MOVE.W	AUDIOCHLEV_0,Y_HALF_SHIFT
	MOVE.W	AUDIOCHLEV_1,BLIT_A_MOD
	MOVE.W	AUDIOCHLEV_2,BLIT_D_MOD
...
__BLK_PLASMA_VECT:
	...
	MOVE.W	D0,MED_SEQ_ACTUAL
	;## DO THINGS AT FIRST FRAME ##
	;MOVE.L	#VECT_COORDS,VECT_PTR	; RESET COORDZ POINTER
	LEA	Drawline\.DrawMode,A1	; BEWARE THE SMC!! ;)
	MOVE.W	#$0B05,2(A1)		; #$0BCA for normal line
	;## DO THINGS AT FIRST FRAME ##
	.noNewBlock:
...
;********** Fastmem Data **********
TIMELINE:		DC.L __BLK_BEGIN,__BLK_BEGIN_MID,__BLK_BEGIN_PRE,__BLK_BEGIN
		...
		DC.L __BLK_SHUFFLE,__BLK_0,__BLK_SHUFFLE,__BLK_0_PRE
		DC.L __BLK_SHUFFLE,__BLK_PLASMA_PRE
		DC.L __BLK_PLASMA,__BLK_PLASMA,__BLK_PLASMA,__BLK_ROUND			;23 27: Occimo!
		DC.L __BLK_PLASMA,__BLK_PLASMA,__BLK_PLASMA,__BLK_DIAG_FLUID1_PRE		;RECOLOR
...
COLORSEQ3:	DC.W $0180,$0000,$0180,$0111,$0180,$0222,$0180,$0333
		DC.W $0180,$0444,$0180,$0555,$0180,$0666,$0180,$0777
		DC.W $0180,$0888,$0180,$0999,$0180,$0AAA,$0180,$0BBB
		DC.W $0180,$0CCC,$0180,$0DDD,$0180,$0EEE,$0180,$0FFF

COLORSEQ4_PTR:	DC.L COLORSEQ4
COLORSEQ4:	DC.W $0180,$0000,$0182,$0222,$0184,$0222,$0186,$0333
		DC.W $0188,$0011,$018A,$00E0,$018C,$0211,$018E,$0110
		DC.W $0188,$0011,$018A,$01D3,$018C,$0221,$018E,$0221
		DC.W $0188,$0122,$018A,$02C5,$018C,$0332,$018E,$0222
		DC.W $0188,$0222,$018A,$03A6,$018C,$0342,$018E,$0333
		DC.W $0188,$0333,$018A,$0497,$018C,$0354,$018E,$0444
		DC.W $0188,$0444,$018A,$0487,$018C,$0455,$018E,$0555
		DC.W $0188,$0544,$018A,$0466,$018C,$0566,$018E,$0666
		DC.W $0188,$0222,$018A,$0545,$018C,$0445,$018E,$0444

		DC.W $0180,$0011,$0182,$0222,$0184,$0232,$0186,$0222
		DC.W $0180,$0111,$0182,$0222,$0184,$0323,$0186,$0111
		DC.W $0180,$0122,$0182,$0222,$0184,$0332,$0186,$0010
		DC.W $0180,$0222,$0182,$0222,$0184,$0333,$0186,$0111
		DC.W $0180,$0233,$0182,$0223,$0184,$0333,$0186,$0222
		DC.W $0180,$0223,$0182,$0333,$0184,$0333,$0186,$0233
		DC.W $0180,$0333,$0182,$0344,$0184,$0111,$0186,$0345
...
COPPER:
	...
	DC.W $0190,$0CCC,$0192,$0DDD,$0194,$0EEE,$0196,$0EFF
